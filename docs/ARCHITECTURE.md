...
- daily (06:00 UTC): rolls retainer.nextBillAt, extends retainer schedules to six future months, cancels retainers past their notice, puts back stage client on any live record whose stage is not a stage but carries clientSince or a won outcome (the nightly enricher has been seen to write stage as ''; the count lands in health.crons.daily.healed), writes the health document.
