...
export const PIPE_EXTRA = {
  ...
  12: { stage: 'client', callStatus: 'booked', clientSince: '2026-12-01T10:00:00Z', clientStatus: 'active',
        /* The retainer client, with a planner on: this is the one that
           exercises the month's delivered count coming from posts rather
           than from Log delivery. */
        planner: { enabled: true, token: 'plnrRETtoken0123456789abcdEFGH', tokenCreatedAt: daysFrom(-45), lastViewedAt: daysFrom(-1), postsPerMonth: 8, welcome: '' },
...
export const posts = [
  ...
  { _id: 'PO9', leadId: 'L12', month: THIS_MONTH, date: daysFrom(3), time: '10:00', platform: 'instagram', imageUrl: '/showcase/fixtures/square.svg', caption: 'Monthly graphic one', status: 'approved', note: '', clientNote: '', clientNoteAt: '', approvedAt: new Date(Date.now() - 2 * 864e5).toISOString(), postedAt: '', order: 0, archived: false, createdAt: NOW_ISO, updatedAt: NOW_ISO },
  { _id: 'PO10', leadId: 'L12', month: THIS_MONTH, date: daysFrom(5), time: '', platform: 'instagram', imageUrl: '', caption: 'Monthly graphic two', status: 'posted', note: '', clientNote: '', clientNoteAt: '', approvedAt: new Date(Date.now() - 4 * 864e5).toISOString(), postedAt: new Date(Date.now() - 3 * 864e5).toISOString(), order: 0, archived: false, createdAt: NOW_ISO, updatedAt: NOW_ISO },
  { _id: 'PO11', leadId: 'L12', month: THIS_MONTH, date: daysFrom(7), time: '', platform: 'instagram', imageUrl: '', caption: 'Monthly graphic three, still being made', status: 'making', note: '', clientNote: '', clientNoteAt: '', approvedAt: '', postedAt: '', order: 0, archived: false, createdAt: NOW_ISO, updatedAt: NOW_ISO },
