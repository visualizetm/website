 ...
 * @param {number} [props.headerHeight] min height for the header card, when the record's header is known to run taller
 * @param {number[]} [props.heights] min heights per content card, so a known record shape lines up
 */
