/* The standard call script skeleton a freshly created lead gets (moved out of
 * AdminCalls.jsx in Prompt 15 so the Leads, Clients, Calendar, and Submissions
 * chunks do not pull the Call Console in). Mirrors api/admin/leads/import.js. */
